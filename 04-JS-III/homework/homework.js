...
function promedioResultadosTest(resultadosTest) {
  ...
  puntaje= resultadosTest[i]+puntaje
...
function diaDeLaSemana(numeroDeDia) {
  ...
  for (let i=0;i<numeroDeDia.length;i++){
    if (numeroDeDia[i]===7 || numeroDeDia===1){
...
//ATENCION! LA RESOLUCION DEL EJERCICIO TODOSIGUALES ES UN POCO DIF
//A LA QUE PROPONE SH. FIJARME LA EXPLICACION DE LA RESOL DEL EJERC
